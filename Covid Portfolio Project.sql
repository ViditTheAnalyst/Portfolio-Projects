...
Select SUM(new_cases) as total_cases , SUM(cast(new_deaths as bigint)) as total_deaths, SUM(cast(new_deaths as bigint))/NULLIF(SUM(new_cases)*100,0) as DeathPercentage
From PortfolioProject..CovidDeaths
where continent is not null 
...
Select *,(RollingPeopleVaccinated/Population)*100 VacPopPercentage
From PopvsVac
